...
export default function ProdukSection() {
  return (
    <section id="produk" className="py-20 bg-gray-50 text-center" data-aos="fade-up">
      <h2 className="text-3xl font-bold text-gray-800 mb-4">Produk Kami</h2>
      <p className="text-gray-500 mb-10 text-lg">Temukan mobil Daihatsu yang sesuai dengan kebutuhan Anda</p>
